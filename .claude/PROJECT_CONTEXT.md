...
Single-file HTML con CSS y JS inline. Desplegado desde GitHub.

## Trabajando en
Mejoras visuales y funcionales al programa del congreso.
...
- Botón "Salir de Edición" visible cuando está activo
...
## Notas técnicas
- El localStorage guarda los datos editados; al hacer cambios en el código original hay que limpiar localStorage para ver los nuevos datos
- Código de acceso a edición: 1904 (hardcoded en JS, no es seguridad real)
